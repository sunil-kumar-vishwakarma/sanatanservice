    ...
    <br><br><br>
            <div class="row py-3 mt-4">
                <div class="col-12">
                    ...
                    <p class="pt-3 text-center" style="padding-left: 167px; padding-right: 184px;">Panchang is the Hindu calendar followed by Vedic astrology, which provides
                            ...
                            <div id="cardholder" class="rounded-lg">
                                <div style="position: initial !important; width: 100% !important;">
                                    <div class="pt-0 mb-1">
                                                ...
                                                <a id="toggleCalendar" class="card-link btn btn-success m-1 bg-white text-dark border-red font-14 font-weight-semi-bold titlecase rounded-25 mt-2"
                                                ...
                                                @endphp
                                       <a class="btn btn-success m-1 {{ $todayActive ? 'bg-red text-white' : 'bg-white text-dark' }} border-red font-14 font-weight-semi-bold titlecase rounded-25 mt-2" href="{{ route('front.getPanchang')}}" style="color: white !important;">TODAY&nbsp;
                                        </a>
                                            <a class="btn btn-success m-1 {{ $tomorrowActive ? 'bg-red text-white' : 'bg-white text-dark' }} border-red font-14 font-weight-semi-bold titlecase rounded-25 mt-2" href="{{ route('front.getPanchang', ['panchangDate' => date('Y-m-d', strtotime('+1 day'))]) }}" style="color: white !important;">TOMORROW&nbsp;
                                          </a>
                                    </div>
                ...
                <div class="col-auto text-center d-flex">
                    @for ($day = 1; $day <= 30; $day++)
                        ...
                        <a href="{{ route('front.getPanchang', ['panchangDate' => $fullDate]) }}" 
                           class="daybox p-1 m-1{{ request('panchangDate', date('Y-m-d')) == $fullDate ? ' high' : '' }}">{{ $day }}</a>
                    @endfor
                </div>
            </div>
        </div>
