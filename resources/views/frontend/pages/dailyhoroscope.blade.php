...
@section('content')
    ...
    <div class="astroway-menu pt-3 bg-pink">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <ul class="list-unstyled horoscope-grid">
                    ...
                    <div class="tab-content mt-4">
                                        ...
                                        <div class="px-3">
                                            <div class="row">
                                                <div class="col-md-6 text-center">
                                                    <div class="my-3">
                                                        <!-- Palette Icon (Lucky Color) -->
                                                        <svg data-name="Group 31019" xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <div class="col-md-6 text-center">
                                                    <div class="my-3">
                                                        <svg data-name="Group 31029" xmlns="http://www.w3.org/2000/svg"
                                                            width="58.271" height="59.841" viewBox="0 0 58.271 59.841">
                                                            <defs>
                                                                <clipPath id="nu">
                        ...
                        <div class="tab-pane fade" id="yearlyData" role="tabpanel">
                            ...
                            <div class="d-md-flex align-items-start">
                                ...
                                <div class="media-body">
                                    <div class="dailyhoroscope-content mt-3">
                                        <p><span>Health Remark :</span> If today is the right day for new beginnings</p>
                                        <p><span>Relationship Remark :</span> If today is the right day for new beginnings
                                        </p>
                                        <p><span>Travel Remark :</span> If today is the right day for new beginnings</p>
                                        <p><span>Family Remark :</span> If today is the right day for new beginnings</p>
                                        <p><span>Friends Remark :</span> If today is the right day for new beginnings</p>
                                        <p><span>Finances Remark :</span> If today is the right day for new beginnings</p>
                                        <p><span>Status Remark :</span> If today is the right day for new beginnings</p>
                                    </div>
                                </div>
                            </div>
                        </div>
