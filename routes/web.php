...
Route::middleware(['auth:admin'])->group(function () {
    ...
    Route::prefix('admin/live')->group(function () {
        ...
        Route::post('/update_arti/{id}', [ArtiController::class, 'update'])->name('admin.live.artis.update');
...
Route::get('/blogDetailspage', [HomeController::class, 'blogDetailspage'])->name('front.blogDetailspage');
