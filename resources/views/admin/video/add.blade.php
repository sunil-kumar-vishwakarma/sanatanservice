...
@section('content')
    ...
    <div class="container">
        <main class="main-content">
            ...
            <h2 style="width: 300px;margin-top: 35px;">Add New Video </h2><a href="{{route('admin.video.video')}}" class="add-button" style="float: right; margin-top: -56px;">+ Back Video</a><br><br>
