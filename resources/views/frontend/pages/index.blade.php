  ...
  <body>
    ...
    <section class="hero">
      <div class="carousel">
        <div class="slides" id="slides">
          ...
          <div class="slide">
            <img src="images/zodiac-signs-1.jpg" alt="slider2" />
          </div>
          <div class="slide">
            <img src="images/slider.jpg" alt="slider3" />
          </div>
          <div class="slide">
    ...
    <section class="facts-section">
      <div class="facts-container">
        ...
        <div class="facts-image">
          <img
            src="images/horoscope-astrology-collage_23-2150719040 (1).jpg"
            alt="Astrology Wheel" />
        </div>
      </div>
    </section>
    ...
    <section class="facts-section">
      <div class="facts-container" id="panchang">
        ...
        <div class="facts-image">
          <img
            src="images/zodiac-circle-with-horoscope-signs-fish-pisces-scorpio-aquarius-zodiak-aries-virgo-vector-illustration_.jpg"
            alt="Astrology Wheel" />
        </div>
      </div>
    </section>
    ...
    <section class="facts-section">
      <div class="facts-container">
        ...
        <div class="facts-image">
          <img
            src="images/zodiac-wheel-space-background_52683-10930.jpg"
            alt="Astrology Wheel" />
        </div>
      </div>
    </section>
    ...
    <section class="facts-section">
      <div class="facts-container" id="panchang">
        ...
        <div class="facts-image">
          <img src="images/panchang.jpg" alt="Astrology Wheel" />
        </div>
      </div>
    </section>
    ...
    <section class="banner" id="banner">
      ...
      <div class="banner-image">
        <img src="images/mobile.jpg" alt="Mobile App" />
    ...
    <section class="features">
      <a href="" class="feature-item">
        <img src="images/TodayPanchang1740225241.png" alt="Panchang" />
        <p>Today's Panchang</p>
      </a>

      <a href="" class="feature-item">
        <img src="images/FreeKundali1707194841.png" alt="Kundli" />
        <p>Janam Kundali</p>
      </a>
      ...
      <a href="" class="feature-item">
        <img src="images/DailyHoroscope1711688425.png" alt="Horoscope" />
    ...
    <footer class="site-footer">
      <div class="footer-content">
        <!-- <div class="footer-column">
          <h4>Get Advice On</h4>
          <ul>
            <li><a href="#banner">Marital Life</a></li>
            <li><a href="#banner">Kids</a></li>
            <li><a href="#banner">Education</a></li>
            <li><a href="#banner">Finance & Business</a></li>
            <li><a href="#banner">Career & Job</a></li>
            <li><a href="#banner">Love & Relationship</a></li>
          </ul>
        </div> -->
        <div class="footer-column">
          <h4>Panchang</h4>
